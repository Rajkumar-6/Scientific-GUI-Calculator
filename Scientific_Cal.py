...
entryField = Entry(root, font=('arial', 20, 'bold'), bg='plum4', fg='white', bd=10, relief=SUNKEN, width=30)
...
for i in button_text_list:
    ...
    button = Button(root, width=5, height=2, bd=2, relief=SUNKEN, text=i, bg='dodgerblue3', fg='white',
                    font=('arial', 18, 'bold'), activebackground='deeppink1', command=lambda button=i: click(button))
